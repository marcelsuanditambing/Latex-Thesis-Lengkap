...
% --- Placeholder gambar (untuk gambar yang belum tersedia) ---
% Ganti pemanggilan \gambarplaceholder{...} dengan \includegraphics{...}
% setelah file gambar yang sesuai ditambahkan ke folder images/.
\newcommand{\gambarplaceholder}[1]{%
  \fbox{\parbox[c][5cm][c]{0.8\textwidth}{\centering\itshape [Placeholder gambar]\\ #1}}%
}
