...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/Baseline Integrasi antar Aplikasi (Silo).drawio.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/Model Integrasi Aplikasi Target.drawio.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/Roadmap implementasi fase Information System Architecture.drawio.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\textwidth]{images/Arsitektur Teknologi Baseline.drawio.png}
\caption{Arsitektur Teknologi \textit{Baseline} Pertahanan}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/Arsitektur Teknologi Target.drawio.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/Roadmap implementasi fase Technology Architecture.drawio.png}
