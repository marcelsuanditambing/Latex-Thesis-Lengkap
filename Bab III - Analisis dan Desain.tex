...
Ketiga sumber tersebut kemudian dianalisis dan disintesiskan menjadi sekumpulan kebutuhan \textit{framework} yang diberi kode KF-01 hingga KF-10. Pemberian kode dimaksudkan agar setiap kebutuhan dapat ditelusuri secara konsisten pada tahap evaluasi kerangka kerja eksisting, tahap perancangan artefak, hingga tahap evaluasi artefak pada Bab IV.
...
\subsection{Evaluasi Pemenuhan Kebutuhan oleh \textit{Framework} Eksisting}
...
\begin{table}[htbp]
\caption{Evaluasi Pemenuhan Kebutuhan dari \textit{Framework} Eksisting}
...
12. Struktur organisasi dan proses bisnis eksisting Kemhan dan TNI\newline
