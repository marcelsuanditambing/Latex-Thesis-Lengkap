...
\begin{enumerate}
\item	Bagaimana kondisi saat ini (as-is) proses bisnis, data, aplikasi dan teknologi di lingkungan Kementerian Pertahanan yang berkaitan dengan transformasi digital?
...
\begin{enumerate}
    \item Mengidentifikasi kondisi saat ini (as-is) ekosistem digital di lingkungan Kementerian Pertahanan, mencakup proses bisnis, aliran data, aplikasi, infrastruktur teknologi 
...
\begin{enumerate}
  ...
  \end{enumerate}
  Data primer ini sangat penting untuk mengidentifikasi kesenjangan (\textit{gap}) antara kondisi saat ini dan kebutuhan arsitektur target.
  \item Data Sekunder.
...
\item	Bab III Analisis dan Desain: Bab ini menyajikan analisis kondisi saat ini Kemhan RI, mencakup analisis organisasi dan tata kelola, regulasi dan kebijakan, permasalahan transformasi digital, serta kebutuhan \textit{smart defense}.
